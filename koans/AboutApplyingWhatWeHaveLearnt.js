...
describe("About Applying What We Have Learnt", function() {
  ...
  it("given I'm allergic to nuts and hate mushrooms, it should find a pizza I can eat (functional)", function () {
      ...
      var productsICanEat = _(products).filter( function(product) { 
        return !hasMushrooms(product) && !product.containsNuts;
      });
  ...
  it("should count the ingredient occurrence (functional)", function () {
    ...
    var ingredientCount = _(_.map(products, function (product) {return product.ingredients})).chain()
      .flatten()
      .reduce(function (counts, product) { counts[product] = ++counts[product] || 1; return counts }, {})
      .value();
